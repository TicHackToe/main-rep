...
.squares---o {
  color: white;
  -webkit-animation: glaw 2s ease-in-out infinite alternate;
  -moz-animation: glaw 2s ease-in-out infinite alternate;
  animation: glaw 2s ease-in-out infinite alternate;
}
